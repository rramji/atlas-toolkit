...
************************************************************************
     ...
     $(bodum(i2),i2=1,35-iag(i1,2)),abo(i1),vlp(i1),ch(i1)
      ...
      else if (icolab.eq.2) then
      do i2=1,iag(i1,2)
      iat2=iag(i1,2+i2)
      call dista2(i1,iat2,dis,dx,dy,dz)
      discnt(i2)=dis
      end do
      if (nsbmax.lt.5) then
      write (7,205)i1,iag(i1,1),(iag(i1,2+i2),i2=1,iag(i1,2)),
     $(idum(i2),i2=1,5-iag(i1,2)),
     $iag(i1,3+mbond),(bo(nubon1(i1,i2)),i2=1,iag(i1,2)),
     $(bodum(i2),i2=1,5-iag(i1,2)),
     $(discnt(i2),i2=1,iag(i1,2)),(bodum(i2),i2=1,5-iag(i1,2)),
     $abo(i1),vlp(i1),ch(i1)
      else if (nsbmax.lt.10) then
      write (7,215)i1,iag(i1,1),(iag(i1,2+i2),i2=1,iag(i1,2)),
     $(idum(i2),i2=1,10-iag(i1,2)),
     $iag(i1,3+mbond),(bo(nubon1(i1,i2)),i2=1,iag(i1,2)),
     $(bodum(i2),i2=1,10-iag(i1,2)),
     $(discnt(i2),i2=1,iag(i1,2)),(bodum(i2),i2=1,10-iag(i1,2)),
     $abo(i1),vlp(i1),ch(i1)
      end if
      end if
      end do
...
*     swb=12.5  !Moved to force field
      ...
      icolab=0     !0: use atom type numbers in connection table  1: use atom names in connection table 2: include distances in connection table
c     shock variables
